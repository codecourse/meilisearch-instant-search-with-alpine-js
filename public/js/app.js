...
window.MeiliSearch = meilisearch__WEBPACK_IMPORTED_MODULE_0__.MeiliSearch;
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(meilisearchConfig, index, searchOptions) {
  var defaultSearchOptions = {
    limit: 10
  };
  searchOptions = _objectSpread(_objectSpread({}, defaultSearchOptions), searchOptions);
  return {
    query: '',
    index: null,
    results: null,
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this2.index.search(query, searchOptions);
